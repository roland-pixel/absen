...
@section('title', 'Tambah Matkul Kelas')
@section('page-title', 'Tambah Data Mata Kuliah Kelas')

@section('content')
<div class="bg-white shadow rounded-lg p-6 max-w-3xl mx-auto">

    {{-- Header --}}
    <h2 class="text-lg font-semibold text-gray-700 mb-4">Form Tambah Mata Kuliah Kelas</h2>
    ...
    {{-- Form --}}
    <form action="{{ route('matkulkelas.store') }}" method="POST" class="space-y-4">
        @csrf

        {{-- Dropdown Mata Kuliah --}}
        <div>
            <label for="matkul_id" class="block text-sm font-medium text-gray-700 mb-1">Mata Kuliah</label>
            <select name="matkul_id" id="matkul_id" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200" required>
        ...
        <div>
            ...
            <select name="kelas_id" id="kelas_id" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200" required>
        ...
        <div>
            ...
            <select name="dosen_id" id="dosen_id" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200" required>
        ...
        <div>
            ...
            <select name="asisten_id" id="asisten_id" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200" required>
                <option value="">-- Pilih Asisten --</option>
                @foreach ($asistens as $asisten)
                    <option value="{{ $asisten->id }}" {{ old('asisten_id') == $asisten->id ? 'selected' : '' }}>
        ...
        <div>
            ...
            <input type="text" name="lab" id="lab" 
                   ...
                   placeholder="Masukkan nama lab" value="{{ old('lab') }}" required>
        </div>
